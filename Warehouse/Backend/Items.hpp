...
std::map<std::string, PackageInfo> PackageInfo::items{
  ...
  {"Bread", {"Bread", 4, 2, 1, 1}},
  {"Cake", {"Cake", 3, 7, 1, 1}},
  {"DriedKelp", {"DriedKelp", 5, 5, 1, 1}},
  {"Egg", {"Egg", 14, 2, 1, 1}},
  {"EnchantedGoldenApple", {"EnchantedGoldenApple", 100, 30, 1, 1}},
  {"GoldenApple", {"GoldenApple", 100, 15, 1, 1}},
  {"Carrot", {"Carrot", 60, 2, 1, 1}},
  {"MelonSlice", {"MelonSlice", 3, 1, 1, 1}},
  {"MushroomStew", {"MushroomStew", 7, 3, 1, 1}},
  {"Potato", {"Potato", 90, 2, 1, 1}},
  {"ChorusFruit", {"ChorusFruit", 10, 6, 1, 1}},
  {"RawBeef", {"RawBeef", 3, 4, 1, 1}},
  {"RawChicken", {"RawChicken", 3, 4, 1, 1}},
  {"RawPorkchop", {"RawPorkchop", 3, 4, 1, 1}},
  {"RawSalmon", {"RawSalmon", 3, 4, 1, 1}},
  {"RottenFlesh", {"RottenFlesh", 1, 1, 1, 1}},
  {"SpiderEye", {"SpiderEye", 4, 8, 1, 1}},
  {"SuspiciousStew", {"SuspiciousStew", 7, 4, 1, 1}},
  {"SweetBerries", {"SweetBerries", 14, 2, 1, 1}},
};
